...
class DiceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.apply {
            ...
            setHomeAsUpIndicator(R.drawable.icon_check)   //If desired add your own icon as the back button
        }
        ...
        //ViewModel saves the UI state on config change thanks to LiveData
